 ...
 */
const executeEditFunction = async ({
  id,
  name,
  description,
  type,
  ...
  const baseURL = ''; // Provide your base URL here or from environment
...
Must send all keys as in the request body.`,
      parameters: {
        type: 'object',
        properties: {
          id: { type: 'string', description: 'The promo code ID to edit.' },
